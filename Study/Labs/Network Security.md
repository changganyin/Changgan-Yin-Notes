...
![](attachments/Pasted%20image%2020251223213550.png)
...
./mycli ycg.com 4433 seed dees 2
```
![](attachments/Pasted%20image%2020251223211657.png)
...
![](attachments/Pasted%20image%2020251223212538.png)
...
```
![](attachments/Pasted%20image%2020251223213045.png)
...
![](attachments/Pasted%20image%2020251223214152.png)

#### 能通信
vpn 连接后，在 HostU 上输入 `ping 192.168.60.101`，可以 ping 通
![](attachments/Pasted%20image%2020251223214418.png)

#### 经隧道封装 & 隧道为 TLS
观察刚才 `ping 192.168.60.101` 时 wireshark 抓包的内容
![](attachments/Pasted%20image%2020251223214507.png)
...
先都连接 VPN
![](attachments/Pasted%20image%2020251223214936.png)
...
sudo /usr/sbin/inetd
```
![](attachments/Pasted%20image%2020251223215816.png)

#### 隧道保持，通信不受影响
端口 HostU2 的 telnet，然后断开 HostU2 的客户端连接；在 HostU 上执行命令 `whoami`，仍能得到正确响应
![](attachments/Pasted%20image%2020251223220019.png)
